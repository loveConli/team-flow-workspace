...
- **设计增强方案当前权威版本**：`docs/architecture-api-db-design-enhancement-v0.16.md`
- **插件版本**：`v0.38.0`（24 skills + 15 agents；0.32.0 打包事故撤回，版本号不可复用）
...
team-flow-workspace/
├── docs/                          # 设计文档（工作区级）
│   ├── architecture-api-db-design-enhancement-v0.16.md # ★ 当前权威版本
...
- **当前权威版本**：`docs/architecture-api-db-design-enhancement-v0.16.md`
- **历史版本**：v0.15/v0.14/v0.13/v0.12/v0.11/v0.8 保留不删；v0.2/v0.3/v0.5/v0.7 已删除，可通过 `git log --all -- "docs/architecture-api-db-design-enhancement-v0.*.md"` 追溯
